  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      ...
      <header className="hidden md:flex flex-col sticky top-0 z-40">
        ...
        {/* Upgrade banner — desktop, inside sticky header */}
        {!isPremium && (
          <div className="flex items-center justify-between px-6 py-2 bg-[#17914A] text-white">
            ...
            <button
              ...
              className="ml-4 px-4 py-1.5 bg-white text-[#17914A] font-semibold rounded-lg text-xs hover:bg-gray-50 transition whitespace-nowrap"
            >
              Upgrade
            </button>
          </div>
      ...
      {!isPremium && (
        <div className="md:hidden fixed bottom-[60px] inset-x-0 z-30 flex items-center justify-between px-4 py-2.5 bg-[#17914A] text-white">
          ...
          <button
            onClick={handleUpgrade}
            className="ml-3 px-3 py-1.5 bg-white text-[#17914A] font-semibold rounded-lg text-xs whitespace-nowrap"
          >
            Upgrade
          </button>
        </div>
