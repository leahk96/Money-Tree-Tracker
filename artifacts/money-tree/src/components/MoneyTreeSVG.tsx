...
const CANOPIES: C[][] = [
  ...
  [
    ...
    { cx:180, cy:108, r:63, fill:"#1a5420" },
  ...
  [
    ...
    { cx:114, cy:104, r:52, fill:"#1e6020" },
    { cx:246, cy:104, r:52, fill:"#1e6020" },
    { cx:180, cy:62,  r:58, fill:"#267426" },
    { cx:128, cy:75,  r:42, fill:"#2e8a2e" },
    { cx:232, cy:75,  r:42, fill:"#2e8a2e" },
    { cx:180, cy:44,  r:42, fill:"#38a038" },
  ...
  [
    ...
    { cx:105, cy:88,  r:62,  fill:"#1c5a1e" },
    { cx:255, cy:88,  r:62,  fill:"#1c5a1e" },
  ...
  [
    ...
    { cx:94,  cy:74,  r:72,  fill:"#1a5420" },
    { cx:266, cy:74,  r:72,  fill:"#1a5420" },
...
function LevelUpCelebration({ stage, onDone }: { stage: number; onDone: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none flex items-center justify-center">
      ...
      {/* Expanding ring */}
      <motion.div
        className="absolute rounded-full border-[3px] border-[#4CAF50]"
