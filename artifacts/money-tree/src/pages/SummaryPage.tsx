    ...
    <div className="max-w-2xl mx-auto px-4 py-6 pb-16 space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-center">
          <h1 className="text-xl font-bold text-[#1a4a1a]">
          ...
          <div className="flex-1 space-y-2">
            <div>
              ...
              <div className="text-3xl font-bold text-[#228B22]">
                {goalsMetCount}<span className="text-lg text-[#9ab89a] font-normal">/12</span>
              </div>
            </div>
            ...
            return (
              <motion.button
                ...
                className={`rounded-xl p-2.5 text-left border-2 transition ${
                  ...
                  : d.goalMet ? "border-[#85BB65] bg-[#f0faf0]"
                  : d.hasData ? "border-[#e8f0e8] bg-white"
                  : "border-dashed border-[#e8f0e8] bg-[#fafcfa]"
                }`}
              >
                <div className={`text-xs font-semibold mb-1 ${d.goalMet ? "text-[#228B22]" : "text-[#5a7a5a]"}`}>
                  {MONTH_NAMES[i]}
                </div>
                {d.hasData ? (
                  <>
                    <div className={`text-sm font-bold tabular-nums ${d.goalMet ? "text-[#228B22]" : "text-[#1a4a1a]"}`}>
      ...
      <motion.button
        ...
        className="w-full py-3 bg-[#f0f8f0] border border-[#c8e4c8] rounded-xl text-sm font-medium text-[#228B22] hover:bg-[#e4f5e4] transition"
      >
        🌳 View your garden →
      </motion.button>
    </div>
